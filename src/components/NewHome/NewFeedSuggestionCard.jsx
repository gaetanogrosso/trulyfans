      ...
      <div className="new-feed-suggestion-box">
        <div className="new-feed-suggestion-header">
          ...
          <div className="new-feed-suggestion-action-btn-sec">
            <Button
              className="icon-btn"
              onClick={() => props.dispatch(fetchPostSuggesstionStart())}
            >
              {/* <i className="fas fa-sync-alt"></i> */}
              <Image
                  src={
                    window.location.origin + "/assets/images/gaetano-icon/reload-icon.svg"
                  }
            ...
            <Button className="icon-btn"  onClick={() =>
              ...
              <Image
                  src={
                    window.location.origin + "/assets/images/gaetano-icon/tags-icon.svg"
                  }
                  className="suggestion-icon"
                />{" "}
            </Button>
