          ...
          <div className="new-feed-user-btn-sec">
            <Button className="sent-tip-btn" onClick={() => setSendTip(true)}>
              <Image
                ...
                src={
                  window.location.origin + "/assets/images/gaetano-icon/tips-icons.svg"
                }
              />
              <span>Tips</span>
            </Button>
            ...
            <div className="new-feed-footer-action-left-sec">
              <Button className="new-feed-wishlist-btn" onClick={(event) => handleLike()}>
                {post.is_user_liked === 1 ?
                  <Image
                    ...
                    src={
                      window.location.origin + "/assets/images/gaetano-icon/fill-like-icon.svg"
                    }
                  />
                  :
                  <Image
                    className="new-feed-wishlist-icon"
                    src={
                      window.location.origin + "/assets/images/gaetano-icon/solid-like-icon.svg"
                    }
                  />
                }
              ...
              <Button className="new-feed-wishlist-btn">
                <Image
                  className="new-feed-wishlist-icon"
                  src={
                    window.location.origin + "/assets/images/gaetano-icon/comment-icon.svg"
                  }
                />
              ...
              <Button className="new-feed-bookmark-btn" onClick={() => handleBookmark()}>
                {post.is_user_bookmarked === 1 ?
                  <Image
                    ...
                    src={
                      window.location.origin + "/assets/images/gaetano-icon/filled-bookmark-home.svg"
                    }
                  />
                  : <Image
                    className="new-feed-bookmark-icon"
                    src={
                      window.location.origin + "/assets/images/gaetano-icon/solid-bookmark-home.svg"
                    }
                  />}
              </Button>
            </div>
