                            ...
                            <div className="new-feed-footer-action-left-sec">
                              ...
                              >
                                ...
                                1 ? (
                                  <Image
                                    ...
                                    src={
                                      window.location.origin +
                                      "/assets/images/gaetano-icon/fill-like-icon.svg"
                                    }
                                  />
                                ) : (
                                  <Image
                                    ...
                                    src={
                                      window.location.origin +
                                      "/assets/images/gaetano-icon/solid-like-icon.svg"
                                    }
                                  />
                                )}
                                <span>
                              ...
                              <Button className="new-feed-wishlist-btn">
                                <Image
                                  ...
                                  src={
                                    window.location.origin +
                                    "/assets/images/gaetano-icon/comment-icon.svg"
                                  }
                                />
                                <span>
                            ...
                            >
                              ...
                              1 ? (
                                <Image
                                  ...
                                  src={
                                    window.location.origin +
                                    "/assets/images/gaetano-icon/filled-bookmark-home.svg"
                                  }
                                />
                              ) : (
                                <Image
