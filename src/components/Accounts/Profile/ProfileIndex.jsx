                                        ...
                                        <Link to={"/edit-profile"}>
                                            <span>
                                                <Image
                                                    ...
                                                    src={
                                                        window.location.origin + "/assets/images/gaetano-icon/edit-profile.svg"
                                                    }
                                                />
                                            </span>
                                            {t("edit_profile")}
                                        ...
                                        <Link to="#" onClick={handleShareClick}>
                                            <span>
                                                <Image
                                                    className="sidebar-links-icon"
                                                    src={
                                                        window.location.origin + "/assets/images/gaetano-icon/share-profile-icon.svg"
                                                    }
                                                />
                                            </span>
                                            {t("share")}
                                            ...
                                            <Link to={"/dashboard"}>
                                                <span>
                                                    <Image
                                                        className="sidebar-links-icon"
                                                        src={
                                                            window.location.origin + "/assets/images/gaetano-icon/dashboard-profile-icon.svg"
                                                        }
                                                    />
                                                </span>
                                                {t("dashboard")}
                                                ...
                                                <Link to={"/become-a-content-creator"}>
                                                    <span>
                                                        <Image
                                                            className="sidebar-links-icon"
                                                            src={
                                                                window.location.origin + "/assets/images/gaetano-icon/become-content-creator.svg"
                                                            }
                                                        />
                                                    </span>
                                                    ...
                                                    <Nav.Link eventKey="all"
                                                        ...
                                                        <span>
                                                            <Image
                                                                ...
                                                                src={
                                                                    window.location.origin + "/assets/images/gaetano-icon/all-profile-icon.svg"
                                                                }
                                                            />
                                                        </span>
                                                    ...
                                                    <Nav.Link eventKey="image"
                                                        ...
                                                        <span>
                                                            <Image
                                                                className="profile-post-tab-icon"
                                                                src={
                                                                    window.location.origin + "/assets/images/gaetano-icon/image-profile-icon.svg"
                                                                }
                                                            />
                                                        </span>
                                                    ...
                                                    <Nav.Link eventKey="video"
                                                        ...
                                                        <span>
                                                            <Image
                                                                className="profile-post-tab-icon"
                                                                src={
                                                                    window.location.origin + "/assets/images/gaetano-icon/video-profile-icon.svg"
                                                                }
                                                            />
                                                        </span>
                                                    ...
                                                    <Nav.Link eventKey="audio"
                                                        ...
                                                        <span>
                                                            <Image
                                                                className="profile-post-tab-icon"
                                                                src={
                                                                    window.location.origin + "/assets/images/gaetano-icon/audio-profile-icon.svg"
                                                                }
                                                            />
                                                        </span>
